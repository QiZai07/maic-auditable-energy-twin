...
The public version uses an anonymized Ningbo reference case with approved aggregate energy, PV and scenario outputs. Its row-level data are deterministic synthetic records generated by `scripts/build_public_demo_data.py`; they preserve the complete application workflow without publishing original institutional data.
